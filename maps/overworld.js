...
class Overworld extends Map {
  constructor(args) {
    ...
    this._width = 80;
    this._height = 80;
    this._tiles = this.generateWorld(); // Add player to map
    ...
    this.addItemsToMap(); // Start player with a placeholder item for now
    ...
    player.getComponent("Slots").slots.hand = shield; //compute the player's initial line of sight
  ...
  generateWorld() {
    ...
    const Templates = Lootr.Templates; // Setup generator
