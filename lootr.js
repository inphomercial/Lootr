...
var Lootr = function (window) {
  ...
  function switchScreen(screen) {
    ...
    getGameDisplay().clear(); // Update our current screen, call Enter

    _currentScreen = screen;

    _currentScreen.enter(getGameDisplay()); // Render our game
  ...
  function switchSubScreen(screen, args) {
    // Clear both displays
    getGameDisplay().clear(); // Update our current screen, call Enter with args that can be passed in

    _currentScreen = screen;

    _currentScreen.enter(getGameDisplay(), args); // Render our game
  ...
  function refreshScreens() {
    // Clear both displays
    getGameDisplay().clear(); // Render our game and
